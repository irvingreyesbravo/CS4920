...
# Function that reads in input, encrypts the message, and writes ciphertext to a file
...
# Run the encryption process for the given file
input_filename = "class_input_b.txt"
output_files = "Reyes_Output_5b.txt"
